...
public class RateLimitRuleValidatorTest {
    ...
    void validateRateLimit_happy(){
        ...
        RateLimitValidateResponse rateLimitValidateResponse = rateLimitValidator.validateRateLimit(apiSignature);
    ...
    void validateRateLimit_NoRateLimitException(){
        ApiSignature apiSignature = ApiSignature.builder()
                ...
                .method(ApiSignature.MethodEnum.GET)
                .build();
        assertThrows(RateLimitException.class,()->rateLimitValidator.validateRateLimit(apiSignature));
    }
