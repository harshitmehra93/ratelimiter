...
public class DurationConvertorTest {
    ...
    void test(){
        ...
        RateLimitDuration SixtySec = RateLimitDuration.builder()
                .unit(RateLimitDuration.UnitEnum.SECONDS)
                .value(60)
                .build();
        RateLimitDuration SixtyMins = RateLimitDuration.builder()
                .unit(RateLimitDuration.UnitEnum.MINUTES)
                .value(60)
                .build();
        RateLimitDuration SixtyHours = RateLimitDuration.builder()
                .unit(RateLimitDuration.UnitEnum.HOURS)
                .value(60)
                .build();
        RateLimitDuration SixtyDays = RateLimitDuration.builder()
